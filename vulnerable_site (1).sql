...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2017 at 01:04 AM
...
CREATE TABLE `users` (
  ...
  `imageURL` varchar(5000) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'https://openclipart.org/image/800px/svg_to_png/215813/Penguin-Icon.png',
  `color` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `privateSnippet` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Admin` tinyint(1) NOT NULL DEFAULT '0',
  `snippetAccess` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'root', 'root@gmail.com', 'root', 'index.php', 'https://openclipart.org/image/800px/svg_to_png/215813/Penguin-Icon.png', NULL, NULL, 1, 1);
